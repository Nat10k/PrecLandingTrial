...
class ArucoSingleTracker():
    def __init__(self,
        ...
        self._aruco_dict  = aruco.getPredefinedDictionary(self._ARUCO_DICT[dict])
    ...
    def track(self, loop=True, verbose=False, show_video=None):
        ...
        newcameramtx, roi = cv2.getOptimalNewCameraMatrix(self._camera_matrix, self._camera_distortion, (h, w), 0, (h, w))
        mapx, mapy = cv2.initUndistortRectifyMap(self._camera_matrix, self._camera_distortion, None, newcameramtx, (w, h), cv2.CV_32FC1)
        xcam, ycam, w1, h1 = roi
        x = 0
        y = 0
        z = 0
...
if __name__ == "__main__":
    ...
    aruco_tracker = ArucoSingleTracker(id_to_find=id_to_find, marker_size=marker_size, dict="DICT_5X5_50", show_video=True, camera_matrix=camera_matrix, camera_distortion=camera_distortion)
