    ...
    if marker_found:
        ...
        if z_cm <= land_alt_cm:
            if vehicle.mode == "GUIDED":
                ...
                vehicle.mode = "LAND"
    elif (uav_location.alt > 5.0) :
        print("Descending because altitude is too high")
        location_marker = LocationGlobalRelative(uav_location.lat, uav_location.lon, uav_location.alt-(land_speed_cms*0.01/freq_send))
        vehicle.simple_goto(location_marker)
